...
if TYPE_CHECKING:  # avoid a runtime import cycle (loader imports normalize_code from here)
    from vignocr.nomenclature.loader import NomenclatureIndex
...
def find(
    ...
    best_conf = 0.0
    best_raw = 0
    for key, row in index.by_key.items():
